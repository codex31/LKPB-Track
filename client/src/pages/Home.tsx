...
export default function Home() {
  ...
  const filteredRecords = useMemo(() => {
    ...
    return data.records.filter((record) => {
      ...
      return matchesStatus && matchesCategory && matchesYear && matchesPool && (!keyword || haystack.includes(keyword));
    });
  }, [data, status, category, year, pool, search]);
