...
export default function Home() {
  ...
  const filteredRecords = useMemo(() => {
    ...
    return data.records.filter((record) => {
      ...
      return matchesStatus && matchesCategory && (!keyword || haystack.includes(keyword));
    });
